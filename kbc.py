...
questions = ["Аббревиатура ICAO расшифровывается как ... ",
             "Главных центров ЕС ОрВД, проводящих обслуживание воздушного движения, существует",
             "Главными требованиями любой транспортной системы являются...",
             "Наиболее крупные по площади и сложные по внутренней структуре элементы ВП ",
             "Границы элементов структуры воздушного пространства устанавливаются по ",
             "Цель управления воздушным движением - обеспечить...",
             "Ситуация,которая приведет к нарушению норм эшелонирования,если не изменить пространственно-временные траектории ВС",
             "Процесс реализации полета по заданной пространственно-временной траектории, в котором участвуют экипаж и диспетчеры службы УВД",
             "Назовите первую дату принятия Конвенции О МЕЖДУНАРОДНОЙ ГРАЖДАНСКОЙ АВИАЦИИ",
             "Предоставление информации и консультаций, необходимых для обеспечения безопасного и эффективного выполнения полетов это",
             "Вид обслуживания ВД, при котором организации получают, возможно, более полную информацию о ВС, нуждающемся в помощи",
             "Основными задачами вычислительного комплекса являются",
             "Какой комплекс МОЖЕТ НЕ входить в состав АС УВД",
             "Установление рациональной структуры воздушного пространства в целях обеспечения его эффективного использования называется",
             "К задачам вторичной обработки радиолокационной информации НЕ относят"]

first_option = ["Международная организация \nуправления воздушным движением", "1",
                "Экономичность, регулярность, \nбезотказность", "Зональный центр ЕС ОрВД",
                "Контрольным азимутам", "Полет по плановой траектории, \nпринимая меры к уменьшению отклонений \nот нее и к предотвращению нарушений \nналагаемых ограничений",
                "Конфликтной ситуацией", "Навигация", " 8 ноября 1944 года", "полетно-информационное\nобслуживание",
                "Полетно-информационное\nоповещение", "сбор, хранения и своевременное\nраспределение плановой информации",
                "комплекс бесперебойного\nэлектропитания", "организацией воздушного движения ", "обнаружение начала траектории\nдвижения каждого ВС"]

second_option = ["Международная организация по \nорганизации воздушного движения", "2",
                 "Экономичность, регулярность, \nбезопасность", "Район аэродрома",
                 "Углу места", "Бесперебойность ВД",
                 "Катастрофой ", "Самолетовождение", "7 декабря 1944 года", "диспетчерское обслуживание ",
                 "Аварийное оповещение", "подготовка и выдача информации\nдля документирования",
                 "комплекс единого времени\nна основе приемников системы\nспутниковой навигации",
                 "организацией ВП", "обнаружение окончания траектории\nдвижения каждого ВС"]

third_option = ["Международная отрасль \nгражданской авиации", "7",
                "Экономичность, робастность, \nбезопасность", "Зона ЕС ОрВД",
                "Фактическим координатам", "Экономичность ВД",
                "Потенциально-конфликтной \nситуацией", "УВД", "9 января 1945 года", "эксплуатационное обслуживание",
                "Консультативное\nоповещение", "обнаружение потенциальных\nконфликтных ситуаций",
                "комплекс документирования\nинформации",
                "организацией использования ВП", "обнаружение полезного\nсигнала в шумах"]

fourth_option = ["Международная организация \nгражданской авиации", "8",
                 "Экономичность, робастность, \nбезотказность", "Коридор входа на воздушные трассы",
                 "Географическим координатам и \nвысотам", "Безопасность ВД",
                 "Чрезвычайным происшествием", "ОВД", "6 сентября 1945 года",
                 "нет верного ответа","Диспетчерское\nоповещение", "Все ответы верны",
                 "тренажерный комплекс", "нет верного ответа",
                 "сглаживание траекторий\nдвижения ВС"]

correct_answers = ["Международная организация \nгражданской авиации", "1", "Экономичность, регулярность, \nбезопасность", "Зона ЕС ОрВД", "Географическим координатам и \nвысотам",
                   "Полет по плановой траектории, \nпринимая меры к уменьшению отклонений \nот нее и к предотвращению нарушений \nналагаемых ограничений",
                   "Потенциально-конфликтной \nситуацией", "Самолетовождение", "7 декабря 1944 года",
                   "полетно-информационное\nобслуживание", "Аварийное оповещение", "Все ответы верны", "тренажерный комплекс", "организацией ВП",
                   "обнаружение полезного\nсигнала в шумах"]
    ...
    for i in range(15):
        if value == correct_answers[i]:
            if value == third_option[14]:
                ...
                winlabel = Label(root2, text='Вы победили!', font=('arial', 30, 'bold'), bg='black', fg='white')
                winlabel.pack()
                ...
                playagainButton = Button(root2, text='Попробовать снова', font=('arial', 20, 'bold'), bg='black', fg='white',
                                         bd=0
                                         , activebackground='black', cursor='hand2', activeforeground='white',
                                         command=playagain)
                playagainButton.pack()

                closeButton = Button(root2, text='Выйти', font=('arial', 20, 'bold'), bg='black', fg='white', bd=0
                                     , activebackground='black', cursor='hand2', activeforeground='white',
                                     command=on_closing)
                closeButton.pack()
        ...
        if value not in correct_answers:
            ...
            imgLabel.pack(pady=30)
            loselabel = Label(root1, text='Вы проиграли', font=('arial', 30, 'bold'), bg='black', fg='white')
            loselabel.pack()
            ...
            tryagainButton = Button(root1, text='Попробовать снова', font=('arial', 20, 'bold'), bg='black', fg='white', bd=0
                                    , activebackground='black', cursor='hand2', activeforeground='white',
                                    command=tryagain)
            tryagainButton.pack()

            closeButton = Button(root1, text='Выйти', font=('arial', 20, 'bold'), bg='black', fg='white', bd=0
                                 , activebackground='black', cursor='hand2', activeforeground='white',
                                 command=on_closing)
            closeButton.pack()
...
root.resizable(0, 0)
root.title('Кто хочет стать миллионером (ОВД) ')
...
questionArea = Text(bottomFrame, font=('arial', 11, 'bold'), bg='black', fg='white', width=50, height=3,
                        wrap='word',bd=0)
...
optionButton1 = Button(bottomFrame, text=first_option[0], font=('arial', 7, 'bold'), bg='black', fg='white',
                              cursor='hand2',bd=0,activebackground='black',activeforeground='white')
optionButton1.place(x=70,y=110)

labelB = Label(bottomFrame, font=('arial', 16, 'bold'), text='B:', bg='black', fg='white')
labelB.place(x=310,y=110)

optionButton2 = Button(bottomFrame, text=second_option[0], font=('arial', 7, 'bold'), bg='black', fg='white',
                              cursor='hand2',bd=0,activebackground='black',activeforeground='white')
optionButton2.place(x=350,y=110)

labelC = Label(bottomFrame, font=('arial', 16, 'bold'), text='C:', bg='black', fg='white')
labelC.place(x=40,y=190)

optionButton3 = Button(bottomFrame, text=third_option[0], font=('arial', 7, 'bold'), bg='black', fg='white',
                             cursor='hand2',bd=0,activebackground='black',activeforeground='white')
optionButton3.place(x=80,y=190)

labelD = Label(bottomFrame, font=('arial', 16, 'bold'), text='D:', bg='black', fg='white')
labelD.place(x=310,y=190)

optionButton4 = Button(bottomFrame, text=fourth_option[0], font=('arial', 7, 'bold'), bg='black', fg='white',
                             cursor='hand2',bd=0,activebackground='black',activeforeground='white')
optionButton4.place(x=350,y=190)

progressbarA = Progressbar(root, orient=VERTICAL, mode='determinate', length=120)

progressbarLabelA = Label(root, text='A', font=('arial', 10, 'bold'), bg='black', fg='white')

progressbarB = Progressbar(root, orient=VERTICAL, mode='determinate', length=120)

progressbarLabelB = Label(root, text='B', font=('arial', 10, 'bold'), bg='black', fg='white')

progressbarC = Progressbar(root, orient=VERTICAL, mode='determinate', length=120)

progressbarLabelC = Label(root, text='C', font=('arial', 10, 'bold'), bg='black', fg='white')

progressbarD = Progressbar(root, orient=VERTICAL, mode='determinate', length=120)

progressbarLabelD = Label(root, text='D', font=('arial', 10, 'bold'), bg='black', fg='white')
